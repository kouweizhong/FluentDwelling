...
{
    public class PlmAllLinkDatabase
    {
        internal PlmAllLinkDatabase()
            : this(new PlmAllLinkDatabaseRecord[] { })
        {
        }

        internal PlmAllLinkDatabase(IList<PlmAllLinkDatabaseRecord> records)
        {
            this.Records = new ReadOnlyCollection<PlmAllLinkDatabaseRecord>(records);
        }

        public ReadOnlyCollection<PlmAllLinkDatabaseRecord> Records { get; private set; }
    }
}
